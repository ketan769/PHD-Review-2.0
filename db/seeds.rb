...
reviews= [{:review_id =>7891, :user_id =>327010110, :year =>2019,:review_score =>'IMP',:comments_for_faculty =>"Great",:review_official_student_deadline =>"2019-11-13"},
          {:review_id =>7928, :user_id =>327005544, :year =>2019,:review_score =>'Sat',:comments_for_faculty =>"Bad"},
          {:review_id =>7928, :user_id =>327005544, :year =>2018,:review_score =>'Gud',:comments_for_faculty =>"OK"}]
