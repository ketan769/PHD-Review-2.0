...
reviews= [{:review_id =>7891, :user_id =>327010110, :year =>2019,:review_score =>'IMP',:comments_for_faculty =>"Great",:review_official_student_deadline =>"2019-11-13",:review_open_date =>"2019-12-13",:ip_official_student_deadline =>'2019-12-13',:dp_official_student_deadline =>'2019-12-13'},
          {:review_id =>7928, :user_id =>327005544, :year =>2019,:review_score =>'Sat',:comments_for_faculty =>"Bad",:review_official_student_deadline =>"2019-11-13",:review_open_date =>"2019-12-13",:ip_official_student_deadline =>'2019-12-13',:dp_official_student_deadline =>'2019-12-13'},
